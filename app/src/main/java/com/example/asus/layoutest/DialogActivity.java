                ...
                switch (v.getId()){
                        ...
                        builder.setTitle("请回答")
                                ...
                                .setPositiveButton("棒", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ToastUtil.shouMsg(DialogActivity.this,"嘻嘻");
                                    }
                                }).setNeutralButton("还行", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                ToastUtil.shouMsg(DialogActivity.this,"你再看看");
                            }
                        }).setNegativeButton("不好", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                ToastUtil.shouMsg(DialogActivity.this,"睁眼说瞎话");
                            }
                        }).show();
                        break;
                    case R.id.btn_dialog2:
                        ...
                        builder2.setTitle("选择性别:").setItems(array2, new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                ToastUtil.shouMsg(DialogActivity.this,array2[which]);
                            }
                        }).show();
                        break;
                    case R.id.btn_dialog3:
                        ...
                        .setSingleChoiceItems(array3, 0, new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                ToastUtil.shouMsg(DialogActivity.this,array3[which]);
                                dialog.dismiss();
                            }
                    ...
                    case R.id.btn_dialog4:
                        ...
                        builder4.setTitle("选择兴趣").setMultiChoiceItems(array4, isSelected, new DialogInterface.OnMultiChoiceClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which, boolean isChecked) {
                                ToastUtil.shouMsg(DialogActivity.this,array4[which]+":"+isChecked);
                            }
                    ...
                    case R.id.btn_dialog5:
                        ...
                        Button login=view.findViewById(R.id.btn_login1);
